...
class HistogramRegistration(object):
    ...
    def __init__(self, from_img, to_img,
                 ...
                 smooth=0, renormalize=False, dist=None, npoints=64**3):
        """
       ...
       npoints : positive integer
         Desired number of voxels in the subsampled bounding box. Default
         is 64**3; smaller values (e.g., 32**3) produce faster but less
         accurate results.
        """
